...
{ 
    ...
    class_<Optimizer>("Optimizer", init<Mol2*, Mol2*, PARSER*>())
        ...
        .def_readonly("Rec", & Optimizer::Rec).add_static_property("Rec", &Optimizer::Rec)
        .def_readonly("RefLig", & Optimizer::RefLig).add_static_property("RefLig", &Optimizer::RefLig)
        .def_readonly("Parser", & Optimizer::Parser).add_static_property("Parser", &Optimizer::Parser)
        .def_readonly("Grids", & Optimizer::Grids).add_static_property("Grids", &Optimizer::Grids)
