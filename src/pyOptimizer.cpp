...
{ 
    ...
    class_<Optimizer>("Optimizer", init<Mol2*, Mol2*, PARSER*>())
        ...
        .add_static_property("Rec",    make_getter(&Optimizer::Rec, return_value_policy<return_by_value>()))
        .add_static_property("RefLig", make_getter(&Optimizer::RefLig, return_value_policy<return_by_value>()))
        .add_static_property("Parser", make_getter(&Optimizer::Parser, return_value_policy<return_by_value>()))
        .add_static_property("Grids",  make_getter(&Optimizer::Grids, return_value_policy<return_by_value>()))
