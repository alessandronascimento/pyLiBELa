...
{ 
    ...
    class_<Optimizer>("Optimizer", init<Mol2*, Mol2*, PARSER*>())
        ...
        .def_readonly("Rec", &Optimizer::Rec, return_value_policy<reference_existing_object>()).staticmethod("Rec")
        .def_readonly("RefLig", & Optimizer::RefLig, return_value_policy<reference_existing_object>()).staticmethod("RefLig")
        .def_readonly("Parser", & Optimizer::Parser, return_value_policy<reference_existing_object>()).staticmethod("Parser")
        .def_readonly("Grids", & Optimizer::Grids, return_value_policy<reference_existing_object>()).staticmethod("Grids")
