...
{ 
    ...
    class_<Optimizer>("Optimizer", init<Mol2*, Mol2*, PARSER*>())
        ...
        .def_readwrite("Rec", &Optimizer::Rec, return_value_policy<manage_new_object>())
        .def_readwrite("RefLig", &Optimizer::RefLig, return_value_policy<manage_new_object>())
        .def_readwrite("Parser", &Optimizer::Parser, return_value_policy<manage_new_object>())
        .def_readwrite("Grids", &Optimizer::Grids, return_value_policy<manage_new_object>())
