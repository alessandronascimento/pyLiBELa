...
{ 
    ...
    class_<Optimizer>("Optimizer", init<Mol2*, Mol2*, PARSER*>())
        ...
        .def_readonly("Rec", make_getter(&Optimizer::Rec, return_value_policy<reference_existing_object>()))
        .def_readonly("RefLig", make_getter(& Optimizer::RefLig, return_value_policy<reference_existing_object>()))
        .def_readonly("Parser", make_getter(& Optimizer::Parser, return_value_policy<reference_existing_object>()))
        .def_readonly("Grids", make_getter(&Optimizer::Grids, return_value_policy<reference_existing_object>()))
