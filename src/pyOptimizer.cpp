...
{ 
    ...
    class_<Optimizer>("Optimizer", init<Mol2*, Mol2*, PARSER*>())
        ...
        .def_readwrite("Rec", & Optimizer::Rec).add_static_property("Rec", &Optimizer::Rec)
        .def_readwrite("RefLig", & Optimizer::RefLig).add_static_property("RefLig", &Optimizer::RefLig)
        .def_readwrite("Parser", & Optimizer::Parser).add_static_property("Parser", &Optimizer::Parser)
        .def_readwrite("Grids", & Optimizer::Grids).add_static_property("Grids", &Optimizer::Grids)
